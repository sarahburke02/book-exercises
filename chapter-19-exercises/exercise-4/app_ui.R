...
intro_panel <- tabPanel(
  ...
  # the US."
  p("The below diagram was created by the Newy York Times to Illustrate the increasing level of inequality in the US"),
...
p(a( href = "http://gabriel-zucman.eu/usdina/"))
)
