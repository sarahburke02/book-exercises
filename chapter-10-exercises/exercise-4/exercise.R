...
# Which organization received the smallest grant? How much was it?

grants[grants$total_amount == min(grants$total_amount), c("organization", "total_amount")]  #vector of columns to return
